...
class DSample:
    ...
    def augment(self, augmentator):
        ...
        #print("hola mundo1") # a parftir de aqui
        #print("shape normal",np.shape(image))
        #print("tipo", type(image))
        self.image = image
        self._encoded_masks = mask
        #print("hola mundo2")
        #self._compute_objects_areas() #aqui el error
        #print("hola mundo3")
        #self.remove_small_objects(min_area=1)
        #print("shape procesado",np.shape(self.image))
